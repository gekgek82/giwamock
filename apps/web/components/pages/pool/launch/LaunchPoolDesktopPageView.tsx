...
import { SelectRelatedPoolSection } from "@/components/pool/launch/SelectRelatedPoolSection";
...
export function LaunchPoolDesktopPageView() {
  const form = useLaunchPoolForm();

  return (
    <SitePageShell className="bg-brand-bg">
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-8 w-full flex flex-col gap-8">
        <SelectTokensSection
          token0={form.token0}
          token1={form.token1}
