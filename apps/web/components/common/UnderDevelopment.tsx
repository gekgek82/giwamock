...
export function UnderDevelopment({ showLayout = true }: UnderDevelopmentProps) {
  const t = useTranslations();

  const content = (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      <div className="bg-neutral-900 rounded-2xl p-8 max-w-md w-full text-center border border-neutral-800">
        <div className="w-16 h-16 bg-primary-700/20 rounded-full flex items-center justify-center mx-auto mb-6">
          <svg
